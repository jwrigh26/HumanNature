  ...
  return (
    <>
      ...
      >
        ...
        material changes to the Terms, Human+Nature will make reasonable effort
        ...
        thirty days after Human+Nature makes reasonable attempt to provide you
      ...
      >
        ...
        Human+Nature within thirty days of receiving the notice of change as
        described under the "Miscellaneous - Notices" below. If Human+Nature is
        ...
        Institution's written service agreement with Human+Nature, or, in the
        ...
        or continued under Human+Nature's then-current Terms.
      </Typography>
    </>
  );
}
