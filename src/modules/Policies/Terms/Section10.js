  ...
  return (
    <>
      ...
      <Typography
        ...
        classes={{ body2: classnames(classes.body2, classes.indent) }}
      >
        <span className={classes.bold}>10.2 Termination by Human+Nature:</span>{' '}
        Khan Academy, in its sole discretion, for any or no reason, and without
        penalty, may suspend or terminate any account (or any part thereof) you
        may have with Human+Nature or your use of the Services and remove and
        discard all or any part of your account, User profile, and User Content,
        at any time. Human+Nature may also in its sole discretion and at any
        time discontinue providing access to the Services, or any part thereof,
        with or without notice. You agree that any termination of your access to
        the Services or any account you may have, or portion thereof, may be
        affected without prior notice, and you agree that Human+Nature will not
        ...
        to any other remedies Human+Nature may have at law or in equity. As
        discussed herein, Human+Nature does not permit copyright, trademarks, or
        other intellectual property infringing activities on the Services, and
        will terminate access to the Services, and remove all User Content or
      ...
      >
        ...
        practice of Human+Nature in operating the Services, or (v) any content
        or information transmitted through the Services, is to terminate the
        Terms and your account. You may terminate these Terms at any time
      ...
      <ol className={classes.listStyleAlpha}>
        <li>
          <Typography variant="body2">
            ...
            the direction of School Personnel, Human+Nature may invite Users, or
            ...
            under Human+Nature's standard account opening process, including
      ...
      >
        ...
        Termination of the Terms as to any User account will not limit
        Human+Nature's rights and remedies regarding any breach of these Terms
