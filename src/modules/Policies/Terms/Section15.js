  ...
  return (
    <>
      ...
      <ol className={classes.listStyleAlpha}>
        <li>
          ...
          >
            ...
            Human+Nature and you agree that any legal or equitable claim,
        ...
        <li>
          <Typography
            ...
            classes={{ body2: classnames(classes.body2, classes.indent) }}
          >
            Notice of Dispute. In the event of a Dispute, you or Human+Nature
            ...
            send any Notice of Dispute by first class U.S. Mail to Human+Nature
            at P.O. Box 1630, Mountain View, CA 94042 and also via e-mail to{' '}
            <Link to={'notices@unimath.app'} blank>
              notices@unimath.app
            </Link>
            . Human+Nature will send any Notice of Dispute to you by first class
            U.S. Mail to your address if Human+Nature has it, or otherwise to
            your e-mail address. You and Human+Nature will attempt in good faith
            ...
            (60) days, you or Human+Nature may commence arbitration.
          </Typography>
        </li>
        <li>
          <Typography
          ...
          >
            ...
            period as you and Human+Nature may otherwise agree, shall be finally
        ...
        <li>
          ...
          >
            ...
            basis. Neither you nor Human+Nature will seek to have any Dispute
        ...
        <li>
          ...
          >
            ...
            forum provided by JAMS is unavailable, Human+Nature and you agree to
        ...
        <li>
          ...
          >
            ...
            filing fee. If Human+Nature files, then Human+Nature will pay; if
        ...
        <li>
          ...
          >
            ...
            action. Notwithstanding this, Human+Nature shall still be allowed to
      ...
      >
        ...
        not be transferred or assigned by you without Human+Nature's prior
        written consent, but may be assigned by Human+Nature without consent or
      ...
      >
        ...
        between you and Human+Nature relating to the subject matter herein and
        will not be modified except in writing, signed by both parties, or by a
        change to the Terms, Privacy Policy or Guidelines made by Human+Nature
      ...
      >
        ...
        offered by Human+Nature: PO Box TBD;{' '}
        <Link to={''} blank>
          notices@unimath.app
        </Link>
        .
      ...
      >
        ...
        acknowledge that these Terms are between you and Human+Nature only, not
