  ...
  return (
    <>
      ...
      >
        ...
        UNIMATH OR THE UNIMATH PARTIES BE LIABLE FOR ANY SPECIAL, INDIRECT,
        ...
        COURT ACTION OR LEGAL DISPUTE, LOST BUSINESS, LOST REVENUES OR PROFITS,
        LOSS OF DATA, OR ANY OTHER PECUNIARY OR NON-PECUNIARY LOSS OR DAMAGE OF
        ANY NATURE WHATSOEVER) EVEN IF UNIMATH OR A UNIMATH PARTIES HAS BEEN
        ADVISED OF THE POSSIBILITY OF SUCH DAMAGES ARISING OUT OF OR RELATING
        (i) TO THE TERMS; (ii) YOUR USE OF (OR INABILITY TO USE) THE WEBSITE OR
        THE UNIMATH OFFERINGS, OR (iii) ANY OTHER INTERACTIONS WITH UNIMATH OR
        ANY THIRD-PARTY THROUGH OR IN CONNECTION WITH THE UNIMATH OFFERINGS,
        INCLUDING OTHER USERS,. APPLICABLE LAW MAY NOT ALLOW THE LIMITATION OR
        ...
        UNIMATH'S LIABILITY WILL BE LIMITED TO THE FULLEST EXTENT PERMITTED BY
        APPLICABLE LAW.
      </Typography>
      <Typography
        variant="body2"
