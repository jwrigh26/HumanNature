...
function Section({ classes }) {
  return (
    <>
      ...
      <Typography
        variant="body2"
        classes={{ body2: classnames(classes.body2, classes.indent1) }}
      >
      ...
      <Typography
        ...
        classes={{ body2: classnames(classes.body2, classes.indent1) }}
      >
        <span className={classes.bold}>1.2</span> Lorem ipsum dolor sit amet,
        consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
        et dolore magna aliqua. In pellentesque massa placerat duis ultricies
        lacus sed turpis tincidunt. A lacus vestibulum sed arcu. Nisl tincidunt
        eget nullam non nisi est. Erat imperdiet sed euismod nisi. Sodales ut
      ...
      <Typography
        ...
        classes={{ body2: classnames(classes.body2, classes.indent1) }}
      >
        <span className={classes.bold}>1.3</span> Lorem ipsum dolor sit amet,
        consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
        et dolore magna aliqua. In pellentesque massa placerat duis ultricies
        lacus sed turpis tincidunt. A lacus vestibulum sed arcu. Nisl tincidunt
        eget nullam non nisi est. Erat imperdiet sed euismod nisi. Sodales ut
