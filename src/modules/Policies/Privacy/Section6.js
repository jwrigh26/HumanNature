  ...
  return (
    <>
      ...
      <Typography variant="body2" classes={{ body2: classes.body2 }}>
        It is Khan Academy's policy to respond to notices of alleged copyright
        infringement that comply with the Digital Millennium Copyright Act. For
        more information, please go to Khan Academy's DMCA Notification
        Guidelines at https://www.khanacademy.org/about/dmca. Khan Academy will
        promptly terminate without notice your access to the Services if you are
        determined by Khan Academy to be a "repeat infringer." A repeat
        infringer is a User who has been notified by Khan Academy of infringing
